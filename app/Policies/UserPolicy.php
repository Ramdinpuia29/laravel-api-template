...
class UserPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete User') || $user->id == $model->id;
    }
    ...
    {
        return $user->checkPermissionTo('restore User') || $user->id == $model->id;
    }
    ...
    {
        return $user->checkPermissionTo('force-delete User') || $user->id == $model->id;
    }
}
